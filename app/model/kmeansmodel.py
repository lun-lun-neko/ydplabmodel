    ...
    if cluster == 0:
            ...
            "analSummary": [
                {
                    ...
                    "content": "이 유형은 운동을 통해 에너지를 충전하는 타입입니다. '관심 여가활동'에서는 스포츠/운동 비율이 가장 높았으며, '여가 목적'에서도 건강 관리가 압도적으로 높았습니다.",
                    "metrics": [
                        {
                            "subtitle": "관심 여가 활동: 스포츠/운동",
                            "content": "이 유형은 관심 여가 활동 1,2 순위로 선택한 비율이 32.65%로 전체 유형 평균인 16.5% 대비 두배 높습니다. 해당 지표는 모든 유형 중 1위에 해당합니다."
                        },
                        {
                            "subtitle": "여가 목적: 건강 관리",
                            "content": "이 유형은 운동 목적에서 ‘건강 관리’를 선택한 비율이 27.3%로, 전체 유형 평균인 12.7% 대비 두 배 이상 높습니다. 해당 지표는 모든 유형 중 1위에 해당합니다."
                        }
                    ]
                },
                {
                    "subtitle": "🙅‍♂️ 단순 휴식은 놉",
                    "content": "레저 시간 중 휴식·오락 비율은 전체 유형(42.2%)보다 훨씬 낮은 16.8%에 불과했습니다. 대신 취미(33.4%), 본인계발(21.4%), 대인관계·교제(27%) 비율이 모두 전체 유형 평균보다 높아 적극적이고 성장 지향적인 여가 활용을 보여줍니다.",
                    "metrics": [
                        {
                            "subtitle": "여가 시간 비율: 휴식·오락 활용",
                            "content": "이 유형은 여가 시간 중 휴식·오락 활용 비율의 평균이 16.8%로, 전체 유형(42.2%) 대비 현저히 낮습니다. 순위는 전체 유형 중 7위로, 휴식에 가장 적은 시간을 할애하는 편입니다."
                        },
                        {
                            "subtitle": "여가 시간 비율(휴식·오락 제외)",
                            "content": "이 유형은 취미, 자기계발, 대인관계·교제 활동에 대한 참여도가 전체 유형 대비 높아, 적극적이고 성장 지향적인 여가 활용 특성을 보입니다."
                        }
                    ]
                }
            ],
        ...
        resultvalue = {
            ...
            "analSummary": [
                {
                    "subtitle": "🧑‍🤝‍🧑 교제·야외활동 선호",
                    "content": "여가 시간 중 대인관계·교제 사용 비율이 모든 유형 중 세 번째로 높습니다. 또한 관심 여가 활동 1순위에서 여행/야외활동 비율이 가장 높고 다른 유형들과 비교했을 때도 가장 높기 때문에, 주변의 친한 친구들과 야외활동 하는 것을 즐기는 유형입니다!",
                    "metrics": [
                        {
                            "subtitle": "여가시간 중 대인관계·교제 사용 비율",
                            "content": "모든 유형 중에서 3위 (27.1%, 전체 유형의 평균 비율 : 23.2%)"
                        },
                        {
                            "subtitle": "관심 여가활동 1순위",
                            "content": "관심 여가 활동 1순위가 여행/야외활동으로 나타났습니다. (24.6%, 모든 유형 중에서도 1위)"
                        }
                    ]
                },
                {
                    "subtitle": "🌈 여가 목적의 다양성",
                    "content": "이 유형은 여가시간 사용 목적 1순위로 스트레스 해소, 가족·지인과의 시간, 자기만족, 마음의 안정·휴식의 항목을 다양하게 선택하였습니다. 그러므로 목적의 1순위는 개인별로 상이하여 특정 항목에 집중되기보단 다양한 양상이 보여집니다!",
                    "metrics": [
                        {
                            "subtitle": "여가시간 사용 목적 1순위",
                            "content": "스트레스 해소(20.7%), 가족·지인 등과 시간(20.4%), 자기만족(17.2%), 마음의 안정·휴식(16.3%) 등으로 다양하게 분포해 있습니다."
                        }
                    ]
                },
                {
                    "subtitle": "🌿 휴식과 관계 중시",
                    "content": "이 유형은 여가시간 사용 목적 2순위로 마음의 안정·휴식이 1위, 가족·지인과의 시간이 2위입니다. 이때, 마음의 안정·휴식, 가족·지인과의 시간은 1순위와 2순위 모두 비율이 높은 편에 속하므로 다른 유형에 비해 마음의 안정·휴식 및 가족·지인과의 시간을 가장 중요시하는 유형인 것으로 보입니다!",
                    "metrics": [
                        {
                            "subtitle": "여가시간 사용 목적 2순위",
                            "content": "마음의 안정·휴식(27.5%), 가족·지인 등과 시간(19.2%)으로 집중되어있습니다."
                        }
                    ]
                }
            ],
        ...
        resultvalue = {
            ...
            "analSummary": [
                {
                    "subtitle": "🛌 휴식이 최고",
                    "content": "여가 시간 중 휴식·오락 사용 비율이 상당히 높군요. 또한 관심 여가 활동 1순위도 휴식 비율이 가장 높습니다. 당신은 편안한 휴식과 일상적 즐거움을 선호하는 유형이네요!",
                    "metrics": [
                        {
                            "subtitle": "여가시간 중 휴식·오락 사용 비율",
                            "content": "이 유형은 여가시간 중 휴식·오락 사용 비율의 평균값이 57.2%로 전체 유형 중 세 번째로 높습니다. 이는 전체 유형의 평균 비율인 42.2%의 약 1.36배입니다."
                        },
                        {
                            "subtitle": "관심 여가활동",
                            "content": "이 유형의 관심 여가활동 1순위 선택 비율은 일상/휴식이 30.4%로 가장 높습니다. 이는 모든 유형 중 세 번째로 높은 비율을 나타냅니다. 다음으로는 미디어/콘텐츠가 24.5%로 두 번째로 높습니다."
                        }
                    ]
                },
                {
                    "subtitle": "🧘마음의 안정·휴식 우선",
                    "content": "이 유형은 여가시간 사용 목적 1순위로 마음의 안정·휴식이 가장 높습니다. 여가의 목적이 휴식인 만큼 자기 계발보다는 마음의 안정과 휴식이 우선인 사람이군요!",
                    "metrics": [
                        {
                            "subtitle": "여가시간 사용 목적",
                            "content": "이 유형의 여가시간 사용 목적 비은 마음의 안정/휴식이 34.4%로 가장 높습니다. 이는 전체 유형 중 두 번째로 높은 비율을 나타냅니다."
                        }
                    ]
                },
            ],
        ...
        resultvalue = {
            ...
            "analSummary": [
                {
                    "subtitle": "💤 휴식 우선 전략",
                    "content": "마음의 안정·휴식을 우선시하는 유형입니다! 이 유형에서는 ‘여가시간 사용 목적 1,2순위’에서 마음의 안정·휴식이 비율이 가장 높았습니다!",
                    "metrics": [
                        {
                            "subtitle": "여가시간 사용 목적 1순위 비율",
                            "content": "마음의 안정·휴식을 위해'가 31.4%로 전체 유형 평균인 22.1%보다 +9.3%높습니다."
                        },
                        {
                            "subtitle": "여가시간 사용 목적 2순위 비율",
                            "content": "'마음의 안정·휴식을 위해'가 27.8%로 전체 유형 평균인 21.7%보다 +6.1%높습니다."
                        }
                    ]
                },
                {
                    ...
                    "metrics": [
                        {
                            "subtitle": "여가시간 중 대인관계·교제 사용 비율",
                            "content": "이 유형에서는 평균값이 8.3%로 전체 유형 평균인 23%보다 -14.7%낮으며, 전체 유형 중 가장 낮습니다."
                        },
                        {
                            "subtitle": "여가시간 중 휴식·오락 사용 비율",
                            "content": "이 유형에서는 평균값이 84%로 전체 유형 평균인 42%보다 +42% 높으며, 전체 유형 중 가장 높습니다."
                        },
                        {
                            "subtitle": "관심여가 활동",
                            "content": "관심여가 활동 1순위에서 ‘일상/휴식' 비율이 37.2%로 전체 유형의 평균 20.9%와 비교대비 압도적으로 높으며, 대부분의 활동 카테고리에서 '참여하는 활동이 없다'는 응답 비율이 월등히 높게 나타납니다."
                        }
                    ]
                }
            ],
            ...
            "analSummary": [
                {
                    ...
                    "content": "‘이 유형은 여가활동을 할 때 자기만족과 즐거움이 우선시되는 유형입니다! 하지만 그 자기만족·즐거움을 마음의 안정과 휴식으로 충족시킬수도 있습니다!",
                    "metrics": [
                        {
                            "subtitle": "여가시간 사용 목적 1순위",
                            "content": " '자기만족·즐거움을 위해'가 20.9%로 가장 높으며, 전체 유형 평균이 18.5%로 전체 유형 평균과 비교했을 때 +2.4%높은걸로 확인되었습니다."
                        },
                        {
                            "subtitle": "여가시간 사용 목적 2순위",
                            "content": " '자기만족·즐거움을 위해'와 ' 마음의 안정·휴식을 위해'의 수치가 20.4%로 가장 높습니다. 각각 전체 유형 평균은 17.0%와 21.9%이며, '자기만족·즐거움을 위해'는 전체 평균보다 +3.4% 높았으며, ' 마음의 안정·휴식을 위해'는 전체 평균보다 -1.5% 낮았습니다."
                        }
                    ]
                },
                {
                    "subtitle": "🏃 상호 보완적 활동",
                    "content": "관심 여가활동 순위에서 [스포츠/운동]과[여행/야외]가 일관된 상위권을 유지했습니다. 평일/주말 평균 여가시간을 고려했을 때 바쁜 일상 속에서도 활동적인 여가로 활기찬 에너지를 얻고, 콘텐츠 시청과 같은 활동으로 편안하게 휴식하며 삶의 균형을 능숙하게 조율하는 사람입니다.",
                    "metrics": [
                        {
                            "subtitle": "관심 여가활동 순위에서 [스포츠/운동]+[여행/야외]의 가중치 비율 ",
                            "content": "관심 여가활동 순위에서  [스포츠/운동]+[여행/야외]의 가중치의 값은 35.4%로 전체 유형 평균의 [스포츠/운동]+[여행/야외] 가중치 비율인 31.0%와 비교했을 때 +4.4% 높습니다."
                        },
                        {
                            "subtitle": "평일 평균 여가시간",
                            "content": " 평일 평균 여가시간은 2.8시간으로 전체 유형 평균인 3.2시간보다 -0.4시간 낮았습니다."
                        },
                        {
                            "subtitle": "주말 평균 여가시간",
                            "content": "주말 평균 여가시간은 5.5시간으로 전체 유형 평균인 6.0시간보다 -0.5시간 낮았습니다."
                        }
                    ]
                }
            ],
            ...
            "analSummary": [
                {
                    ...
                    "metrics": [
                        {
                            "subtitle": "평균 여가 시간",
                            "content": "여가 시간이 주중 평균 5.56시간, 주말 평균 7.46시간으로, **모든 유형 중 가장 많은 여가 시간**을 가집니다. 또한 전체 유형의 평균 여가 시간(전체 평균 여가 시간 수) 보다 약 1.8배 높습니다. "
                        }
                    ]
                },
                {
                    "subtitle": "😴 휴식이 보약",
                    "content": "당신은 여가 시간의 대부분을 휴식과 오락에 사용하며, 활동적인 취미나 자기계발보다는 **미디어/콘텐츠 시청**이나 **일상/휴식**과 같이 조용하고 편안한 활동을 선호하는 사람입니다. 당신에게 여가란 일상에서 벗어나 에너지를 회복하는 시간입니다!",
                    "metrics": [
                        {
                            "subtitle": "여가 목적 ",
                            "content": " 여가 목적의 1순위가 ‘마음의 안정/휴식’을 차지했으며(49.1%) 전체 유형의 비율(25.1%)보다 약 2배 정도 높습니다. 또한 여가 목적 2순위에서는 ‘**스트레소 해소를 위해**’ 항목이 가장 많은 비율(21.8%)를 차지했으며 전체 유형의 비율(13%)보다 약 1.7배 높습니다. "
                        }
                    ]
                },
                {
                    "subtitle": "🪫 충전이 필요해!",
                    "content": "당신은 여가 시간 중 취미와 자기계발의 비율이 전체 유형 중에서 가장 낮지만 당신은 단순히 비활동적인 것이 아니라, 현재의 삶에서 가장 필요한 ‘**휴식**’에 집중하는 현명한 사람들일 수 있습니다.",
                    "metrics": [
                        {
                            "subtitle": "관심 여가 활동 ",
                            "content": "이 유형의 관심 여가 활동 1순위는 ‘**미디어/콘텐츠’(43.6%)**이며 전체 유형의 평균(22%)보다 약 2배 정도 높습니다. 2순위부터는 36% 이상이 ‘**일상/휴식’** 항목을 선택했으며 전체 유형의 평균(19.8%)보다 약 1.8배 높습니다."
                        }
                    ]
                }
            ],
